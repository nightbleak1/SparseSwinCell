# Running an Experiment Using Sparse CellViT cell segmentation network
#
...
from cell_segmentation.experiments.experiment_sparse_cellvit_pannuke import (
    ExperimentSparseCellViTPanNuke,
)
from cell_segmentation.experiments.experiment_sparse_cellvit_conic import (
    ExperimentSparseCellViTCoNic,
)
...
if __name__ == "__main__":
    ...
    if configuration["data"]["dataset"].lower() == "pannuke":
        experiment_class = ExperimentSparseCellViTPanNuke
    elif configuration["data"]["dataset"].lower() == "conic":
        experiment_class = ExperimentSparseCellViTCoNic
    # Setup experiment
